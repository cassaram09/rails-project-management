...
@ramsay = User.create(name: "Ramsay Bolton", email: "ramsay@dreadfort.westeros", password: "hello123")
@tyrion = User.create(name: "Tyrion Lannister", email: "tyrion@castleyrock.westeros", password: "hello123")
...
@task = Task.create(project_id: 1, user_id: 1, name: "Secure the tunnel", description: "flood the tunnel so it can't be be breached by the wildings", due_date: "2016-07-23" )
@comment = Comment.create(user_id: 2, task_id: 1, content: "This is a comment by Ramsay Bolton. Why am I even here?")
